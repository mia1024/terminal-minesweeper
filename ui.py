...
class RootWidget(Widget):
    ...
    def render(self):
        ...
        self.addstr(self.status_y_offset + 12, self.status_x_offset + 5, ('🏁' if emo else 'Ｘ') + ' Correct flag')
        self.addstr(self.status_y_offset + 13, self.status_x_offset + 5, ('💣' if emo else 'Ｏ') + ' Remaining mine')
